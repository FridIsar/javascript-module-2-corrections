...
submitButton.addEventListener("click",checkInputFieldisValid);
   ...
   function checkInputFieldisValid(event) { 
    ...
    event.preventDefault();   // TODO if we only fill the third field we still get the "Thank you message". This is because here the else is only linked to the third if. How can you go in this else only if the 3 if conditions are not met?
