...
let destinationNameReachableByFerry = travelDestinations.filter((e) => e.transportations.includes("ferry")).map((e)=> e.destinationName)                 // Complete here

let destinationNamesMoreThan300KmsAwayByTrain = travelDestinations.filter((e) => e.transportations.includes("train")).map((e) => e.destinationName)  // Complete here (PRINT THE RESULT IN THE CONSOLE USING FOREACH)
